...
dataset = load_carmenes_data(folder='/users/ricolandman/Documents/Research/OH_exoplanets/Data/Wasp76_NIR/', spectral_orders=[23,24,25,26,27])
...
pipeline.run(dataset, num_workers=5) 
pipeline.summary()
