...
#template_wl, template = np.load('/users/ricolandman/Documents/Research/OH_exoplanets/Data/models/Wasp76_OH_equilibrium_T=2600K_prepared.npy')
template_wl, template = np.load('/users/ricolandman/Documents/Research/Proposals/Models//Data/models/wasp33_OH_main_iso_proposal_model.npy')
...
pipeline.add_module( FlagAbsorptionEmissionModule(flux_lower_limit=0.4, flux_upper_limit=1.2, 
...
plt.colorbar()
plt.xlabel('RV [km/s]')
not_intransit = ~planet.in_transit()
